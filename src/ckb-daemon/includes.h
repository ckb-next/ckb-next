...
#define ckb_fatal_fn(fmt, file, line, args...)  fprintf(stderr, "[F] %s (%s:%d): " fmt, __func__, file, line, ## args)
#define ckb_fatal(fmt, args...)                 ckb_fatal_fn(fmt, __FILE_NOPATH__, __LINE__, ## args)
#define ckb_err_nofile(fmt, args...)            fprintf(stderr, "[E] " fmt, ## args)
#define ckb_err_fn(fmt, file, line, args...)    fprintf(stderr, "[E] %s (%s:%d): " fmt, __func__, file, line, ## args)
#define ckb_err(fmt, args...)                   ckb_err_fn(fmt, __FILE_NOPATH__, __LINE__, ## args)
#define ckb_warn_nofile(fmt, args...)           printf("[W] " fmt, ## args)
#define ckb_warn_fn(fmt, file, line, args...)   printf("[W] %s (%s:%d): " fmt, __func__, file, line, ## args)
#define ckb_warn(fmt, args...)                  ckb_warn_fn(fmt, __FILE_NOPATH__, __LINE__, ## args)
#define ckb_info_nofile(fmt, args...)           printf("[I] " fmt, ## args)
#define ckb_info_fn(fmt, file, line, args...)   printf("[I] " fmt, ## args)
#define ckb_info(fmt, args...)                  ckb_info_fn(fmt, __FILE_NOPATH__, __LINE__, ## args)
