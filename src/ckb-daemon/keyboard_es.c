...
const key keymap_es[N_KEYS] = {
    ...
    { "k",          0x63, KEY_K },
    { "l",          0x6f, KEY_L },
    { "nn",         0x7b, KEY_SEMICOLON },
    { "accent",     0x87, KEY_APOSTROPHE },
    ...
    { "cc",         0x72, KEY_BACKSLASH },
    { "enter",      0x7e, KEY_ENTER },
    { 0,            -1,   KEY_NONE },
    { "lexclam",    0x07, KEY_EQUAL },
    { 0,            -1,   KEY_NONE },
