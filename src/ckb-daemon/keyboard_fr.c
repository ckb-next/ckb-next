...
const key keymap_fr[N_KEYS] = {
    ...
    { "k",          0x63, KEY_K },
    { "l",          0x6f, KEY_L },
    { "m",          0x7b, KEY_SEMICOLON },
    { "percent",    0x87, KEY_APOSTROPHE },
    ...
    { "n",          0x58, KEY_N },
    { "comma",      0x64, KEY_M },
    { "semicolon",  0x70, KEY_COMMA },
    { "colon",      0x7c, KEY_DOT },
    { "exclam",     0x88, KEY_SLASH },
    ...
    { "dollar",     0x5a, KEY_RIGHTBRACE },
    { 0,            0x66, KEY_BACKSLASH },
    { "star",       0x72, KEY_BACKSLASH },
