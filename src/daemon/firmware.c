...
int fwupdate(usbdevice* kb, const char* path, int nnumber)
{
    ...
    uchar data_pkt[7][MSG_SIZE] = { { CMD_SET, FIELD_FW_START, 0xf0, 0x01, 0 }, { CMD_SET, FIELD_FW_DATA, 0xf0, 0 },
                                    { CMD_WRITE_BULK, 0x01, 0x3c, 0 },          { CMD_WRITE_BULK, 0x02, 0x3c, 0 },
                                    { CMD_WRITE_BULK, 0x03, 0x3c, 0 },          { CMD_WRITE_BULK, 0x04, 0x3c, 0 },
    ...
    uchar data_pkt2[2][MSG_SIZE] = { { CMD_SET, FIELD_FW_DATA, 0xf0, 0x00, 0x00, 0x00, index }, { CMD_SET, FIELD_RESET, RESET_SLOW, 0 } };
