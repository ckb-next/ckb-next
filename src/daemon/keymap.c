...
const key keymap[N_KEYS_EXTENDED] = {
    ...
    { "dpi5",       LED_MOUSE + 11, KEY_NONE },
        ...
        // Generic Zone LL120
    { "fan1bottominner",      0x00, KEY_NONE },
    { "fan1leftinner",        0x01, KEY_NONE },
    { "fan1topinner",         0x02, KEY_NONE },
    { "fan1rightinner",       0x03, KEY_NONE },
    { "fan1tenoclock",        0x04, KEY_NONE },
    { "fan1nineoclock",       0x05, KEY_NONE },
    { "fan1eightoclock",      0x06, KEY_NONE },
    { "fan1sevenoclock",      0x07, KEY_NONE },
    { "fan1sixoclock",        0x08, KEY_NONE },
    { "fan1fiveoclock",       0x09, KEY_NONE },
    { "fan1fouroclock",       0x0a, KEY_NONE },
    { "fan1threeoclock",      0x0b, KEY_NONE },
    { "fan1twooclock",        0x0c, KEY_NONE },
    { "fan1oneoclock",        0x0d, KEY_NONE },
    { "fan1twelveoclock",     0x0e, KEY_NONE },
    { "fan1elevenoclock",     0x0f, KEY_NONE },
    { "fan2bottominner",      0x10, KEY_NONE },
    { "fan2leftinner",        0x11, KEY_NONE },
    { "fan2topinner",         0x12, KEY_NONE },
    { "fan2rightinner",       0x13, KEY_NONE },
    { "fan2tenoclock",        0x14, KEY_NONE },
    { "fan2nineoclock",       0x15, KEY_NONE },
    { "fan2eightoclock",      0x16, KEY_NONE },
    { "fan2sevenoclock",      0x17, KEY_NONE },
    { "fan2sixoclock",        0x18, KEY_NONE },
    { "fan2fiveoclock",       0x19, KEY_NONE },
    { "fan2fouroclock",       0x1a, KEY_NONE },
    { "fan2threeoclock",      0x1b, KEY_NONE },
    { "fan2twooclock",        0x1c, KEY_NONE },
    { "fan2oneoclock",        0x1d, KEY_NONE },
    { "fan2twelveoclock",     0x1e, KEY_NONE },
    { "fan2elevenoclock",     0x1f, KEY_NONE },
    { "fan3bottominner",      0x20, KEY_NONE },
    { "fan3leftinner",        0x21, KEY_NONE },
    { "fan3topinner",         0x22, KEY_NONE },
    { "fan3rightinner",       0x23, KEY_NONE },
    { "fan3tenoclock",        0x24, KEY_NONE },
    { "fan3nineoclock",       0x25, KEY_NONE },
    { "fan3eightoclock",      0x26, KEY_NONE },
    { "fan3sevenoclock",      0x27, KEY_NONE },
    { "fan3sixoclock",        0x28, KEY_NONE },
    { "fan3fiveoclock",       0x29, KEY_NONE },
    { "fan3fouroclock",       0x2a, KEY_NONE },
    { "fan3threeoclock",      0x2b, KEY_NONE },
    { "fan3twooclock",        0x2c, KEY_NONE },
    { "fan3oneoclock",        0x2d, KEY_NONE },
    { "fan3twelveoclock",     0x2e, KEY_NONE },
    { "fan3elevenoclock",     0x2f, KEY_NONE },
    { "fan4bottominner",      0x30, KEY_NONE },
    { "fan4leftinner",        0x31, KEY_NONE },
    { "fan4topinner",         0x32, KEY_NONE },
    { "fan4rightinner",       0x33, KEY_NONE },
    { "fan4tenoclock",        0x34, KEY_NONE },
    { "fan4nineoclock",       0x35, KEY_NONE },
    { "fan4eightoclock",      0x36, KEY_NONE },
    { "fan4sevenoclock",      0x37, KEY_NONE },
    { "fan4sixoclock",        0x38, KEY_NONE },
    { "fan4fiveoclock",       0x39, KEY_NONE },
    { "fan4fouroclock",       0x3a, KEY_NONE },
    { "fan4threeoclock",      0x3b, KEY_NONE },
    { "fan4twooclock",        0x3c, KEY_NONE },
    { "fan4oneoclock",        0x3d, KEY_NONE },
    { "fan4twelveoclock",     0x3e, KEY_NONE },
    { "fan4elevenoclock",     0x3f, KEY_NONE },
    { "fan5bottominner",      0x40, KEY_NONE },
    { "fan5leftinner",        0x41, KEY_NONE },
    { "fan5topinner",         0x42, KEY_NONE },
    { "fan5rightinner",       0x43, KEY_NONE },
    { "fan5tenoclock",        0x44, KEY_NONE },
    { "fan5nineoclock",       0x45, KEY_NONE },
    { "fan5eightoclock",      0x46, KEY_NONE },
    { "fan5sevenoclock",      0x47, KEY_NONE },
    { "fan5sixoclock",        0x48, KEY_NONE },
    { "fan5fiveoclock",       0x49, KEY_NONE },
    { "fan5fouroclock",       0x4a, KEY_NONE },
    { "fan5threeoclock",      0x4b, KEY_NONE },
    { "fan5twooclock",        0x4c, KEY_NONE },
    { "fan5oneoclock",        0x4d, KEY_NONE },
    { "fan5twelveoclock",     0x4e, KEY_NONE },
    { "fan5elevenoclock",     0x4f, KEY_NONE },
    { "fan6bottominner",      0x50, KEY_NONE },
    { "fan6leftinner",        0x51, KEY_NONE },
    { "fan6topinner",         0x52, KEY_NONE },
    { "fan6rightinner",       0x53, KEY_NONE },
    { "fan6tenoclock",        0x54, KEY_NONE },
    { "fan6nineoclock",       0x55, KEY_NONE },
    { "fan6eightoclock",      0x56, KEY_NONE },
    { "fan6sevenoclock",      0x57, KEY_NONE },
    { "fan6sixoclock",        0x58, KEY_NONE },
    { "fan6fiveoclock",       0x59, KEY_NONE },
    { "fan6fouroclock",       0x5a, KEY_NONE },
    { "fan6threeoclock",      0x5b, KEY_NONE },
    { "fan6twooclock",        0x5c, KEY_NONE },
    { "fan6oneoclock",        0x5d, KEY_NONE },
    { "fan6twelveoclock",     0x5e, KEY_NONE },
    { "fan6elevenoclock",     0x5f, KEY_NONE },
};
