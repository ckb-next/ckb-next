...
const key keymap_bragi[N_KEYS_BRAGI_PATCH] = {
    ...
    { "ctrlwheel1",    182, KEY_NONE },
    { "ctrlwheel2",    183, KEY_NONE },
    { "ctrlwheel3",    184, KEY_NONE },
    { "ctrlwheel4",    185, KEY_NONE },
    { "ctrlwheel5",    186, KEY_NONE },
    { "ctrlwheel6",    187, KEY_NONE },
    { "ctrlwheel7",    188, KEY_NONE },
    { "ctrlwheel8",    189, KEY_NONE },
