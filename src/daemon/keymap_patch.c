...
keypatches mappatches[] = {
    { V_CORSAIR, P_K68, k63patch, K63PATCH_LEN },      { V_CORSAIR, P_K68_NRGB, k63patch, K63PATCH_LEN },
    { V_CORSAIR, P_K65, k65patch, K65PATCH_LEN },      { V_CORSAIR, P_K65_LEGACY, k65patch, K65PATCH_LEN },
    { V_CORSAIR, P_K63_NRGB, k63patch, K63PATCH_LEN }, { V_CORSAIR, P_M95, m95patch, M95PATCH_LEN },
};
