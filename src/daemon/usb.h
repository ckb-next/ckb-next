...
/// 12| Nightsabre mice | IS_NIGHTSABRE()
///
...
#define P_NIGHTSABRE_WL      0x1bb8
#define IS_NIGHTSABRE(kb)    ((kb)->vendor == V_CORSAIR && ((kb)->product == P_NIGHTSABRE_WL))
...
#define SW_PKT_HAS_NO_WHEEL(kb)                     ((kb)->vendor == V_CORSAIR && ((kb)->product == P_M55_RGB_PRO || (kb)->product == P_KATAR_PRO_XT || (kb)->product == P_KATAR_PRO || (kb)->product == P_NIGHTSABRE_WL))
