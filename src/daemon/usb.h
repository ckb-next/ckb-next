...
#define usbsend_control(kb, message, len, bRequest, wValue, wIndex, with_delay) _usbsend_control(kb, message, len, bRequest, wValue, wIndex, with_delay, __FILE_NOPATH__, __LINE__)
