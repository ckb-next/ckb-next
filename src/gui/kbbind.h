...
public:
    ...
    inline void setAction(const QStringList& keys, const QString& action)
    {
    ...
    inline void resetAction(const QStringList& keys)
    {
        foreach (const QString& key, keys)
            resetAction(key);
    }
    ...
    inline void noAction(const QStringList& keys)
    {
        foreach (const QString& key, keys)
            noAction(key);
    }
