...
KbPerf::KbPerf(KbMode* parent)
    : QObject(parent), runningPushIdx(1), _iOpacity(1.f), _dpiIndicator(true), _liftHeight(MEDIUM), _angleSnap(false), _needsUpdate(true), _needsSave(true)
{
...
KbPerf::KbPerf(KbMode* parent, const KbPerf& other)
    : QObject(parent), dpiCurX(other.dpiCurX), dpiCurY(other.dpiCurY), dpiBaseIdx(other.dpiBaseIdx), runningPushIdx(1), _iOpacity(other._iOpacity),
      light100Color(other.light100Color), muteNAColor(other.muteNAColor), _dpiIndicator(other._dpiIndicator), _liftHeight(other._liftHeight),
      _angleSnap(other._angleSnap), _needsUpdate(true), _needsSave(true)
{
...
{
    dpiCurX = other.dpiCurX;
    dpiCurY = other.dpiCurY;
    dpiBaseIdx = other.dpiBaseIdx;
    runningPushIdx = 1;
    _iOpacity = other._iOpacity;
    light100Color = other.light100Color;
    muteNAColor = other.muteNAColor;
    _dpiIndicator = other._dpiIndicator;
    _liftHeight = other._liftHeight;
    _angleSnap = other._angleSnap;
    _needsUpdate = true;
    _needsSave = true;
    memcpy(dpiX, other.dpiX, sizeof(dpiX));
    memcpy(dpiY, other.dpiY, sizeof(dpiY));
