...
static const Key LightningNodeProZones[] = {
    // Fan 1
    {0, "Fan 1 Bottom Inner", "fan1bottominner", FAN1_OFFSET_X, -LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 1 Left Inner", "fan1leftinner", -LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X, FAN1_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 1 Top Inner", "fan1topinner", FAN1_OFFSET_X, LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 1 Right Inner", "fan1rightinner", LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X, FAN1_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Ten O Clock", "fan1tenoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Nine O Clock", "fan1nineoclock", 3 * -LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X, FAN1_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Eight O Clock", "fan1eightoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Seven O Clock", "fan1sevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Six O Clock", "fan1sixoclock", FAN1_OFFSET_X, 3 * LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Five O Clock", "fan1fiveoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Four O Clock", "fan1fouroclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Three O Clock", "fan1threeoclock", 3 * LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X, FAN1_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Two O Clock", "fan1twooclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 One O Clock", "fan1oneoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Twelve O Clock", "fan1twelveoclock", FAN1_OFFSET_X, 3 * -LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 1 Eleven O Clock", "fan1elevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN1_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN1_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},

    // Fan 2
    {0, "Fan 2 Bottom Inner", "fan2bottominner", FAN2_OFFSET_X, -LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 2 Left Inner", "fan2leftinner", -LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X, FAN2_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 2 Top Inner", "fan2topinner", FAN2_OFFSET_X, LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 2 Right Inner", "fan2rightinner", LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X, FAN2_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Ten O Clock", "fan2tenoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Nine O Clock", "fan2nineoclock", 3 * -LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X, FAN2_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Eight O Clock", "fan2eightoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Seven O Clock", "fan2sevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Six O Clock", "fan2sixoclock", FAN2_OFFSET_X, 3 * LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Five O Clock", "fan2fiveoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Four O Clock", "fan2fouroclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Three O Clock", "fan2threeoclock", 3 * LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X, FAN2_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Two O Clock", "fan2twooclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 One O Clock", "fan2oneoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Twelve O Clock", "fan2twelveoclock", FAN2_OFFSET_X, 3 * -LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 2 Eleven O Clock", "fan2elevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN2_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN2_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},

    // Fan 3
    {0, "Fan 3 Bottom Inner", "fan3bottominner", FAN3_OFFSET_X, -LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 3 Left Inner", "fan3leftinner", -LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X, FAN3_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 3 Top Inner", "fan3topinner", FAN3_OFFSET_X, LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 3 Right Inner", "fan3rightinner", LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X, FAN3_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Ten O Clock", "fan3tenoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Nine O Clock", "fan3nineoclock", 3 * -LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X, FAN3_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Eight O Clock", "fan3eightoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Seven O Clock", "fan3sevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Six O Clock", "fan3sixoclock", FAN3_OFFSET_X, 3 * LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Five O Clock", "fan3fiveoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Four O Clock", "fan3fouroclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Three O Clock", "fan3threeoclock", 3 * LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X, FAN3_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Two O Clock", "fan3twooclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 One O Clock", "fan3oneoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Twelve O Clock", "fan3twelveoclock", FAN3_OFFSET_X, 3 * -LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 3 Eleven O Clock", "fan3elevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN3_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN3_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},

    // Fan 4
    {0, "Fan 4 Bottom Inner", "fan4bottominner", FAN4_OFFSET_X, -LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 4 Left Inner", "fan4leftinner", -LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X, FAN4_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 4 Top Inner", "fan4topinner", FAN4_OFFSET_X, LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 4 Right Inner", "fan4rightinner", LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X, FAN4_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Ten O Clock", "fan4tenoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Nine O Clock", "fan4nineoclock", 3 * -LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X, FAN4_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Eight O Clock", "fan4eightoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Seven O Clock", "fan4sevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Six O Clock", "fan4sixoclock", FAN4_OFFSET_X, 3 * LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Five O Clock", "fan4fiveoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Four O Clock", "fan4fouroclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Three O Clock", "fan4threeoclock", 3 * LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X, FAN4_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Two O Clock", "fan4twooclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 One O Clock", "fan4oneoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Twelve O Clock", "fan4twelveoclock", FAN4_OFFSET_X, 3 * -LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 4 Eleven O Clock", "fan4elevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN4_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN4_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},

    // Fan 5
    {0, "Fan 5 Bottom Inner", "fan5bottominner", FAN5_OFFSET_X, -LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 5 Left Inner", "fan5leftinner", -LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X, FAN5_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 5 Top Inner", "fan5topinner", FAN5_OFFSET_X, LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 5 Right Inner", "fan5rightinner", LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X, FAN5_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Ten O Clock", "fan5tenoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Nine O Clock", "fan5nineoclock", 3 * -LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X, FAN5_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Eight O Clock", "fan5eightoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Seven O Clock", "fan5sevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Six O Clock", "fan5sixoclock", FAN5_OFFSET_X, 3 * LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Five O Clock", "fan5fiveoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Four O Clock", "fan5fouroclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Three O Clock", "fan5threeoclock", 3 * LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X, FAN5_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Two O Clock", "fan5twooclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 One O Clock", "fan5oneoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Twelve O Clock", "fan5twelveoclock", FAN5_OFFSET_X, 3 * -LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 5 Eleven O Clock", "fan5elevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN5_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN5_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},

    // Fan 6
    {0, "Fan 6 Bottom Inner", "fan6bottominner", FAN6_OFFSET_X, -LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 6 Left Inner", "fan6leftinner", -LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X, FAN6_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 6 Top Inner", "fan6topinner", FAN6_OFFSET_X, LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false}, 
    {0, "Fan 6 Right Inner", "fan6rightinner", LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X, FAN6_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Ten O Clock", "fan6tenoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Nine O Clock", "fan6nineoclock", 3 * -LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X, FAN6_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Eight O Clock", "fan6eightoclock", (short)(2.6 * -LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Seven O Clock", "fan6sevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Six O Clock", "fan6sixoclock", FAN6_OFFSET_X, 3 * LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Five O Clock", "fan6fiveoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X), (short)(2.6 * LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Four O Clock", "fan6fouroclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X), (short)(1.5 * LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Three O Clock", "fan6threeoclock", 3 * LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X, FAN6_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Two O Clock", "fan6twooclock", (short)(2.6 * LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X), (short)(1.5 * -LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 One O Clock", "fan6oneoclock", (short)(1.5 * LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Twelve O Clock", "fan6twelveoclock", FAN6_OFFSET_X, 3 * -LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y, LIGHTNODE_PRO_SIZE, true, false},
    {0, "Fan 6 Eleven O Clock", "fan6elevenoclock", (short)(1.5 * -LIGHTNODE_PRO_SIZE_X + FAN6_OFFSET_X), (short)(2.6 * -LIGHTNODE_PRO_SIZE_Y + FAN6_OFFSET_Y), LIGHTNODE_PRO_SIZE, true, false},
};
