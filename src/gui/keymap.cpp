...
static const Key K68TopRow[] = {
    { 0, "Volume Down", "voldn", 285 - K70_X_START, 0, 13, 8, true, true },
    { 0, "Volume Up", "volup", 297 - K70_X_START, 0, 13, 8, true, true },
};
#define K68_TOP_COUNT (sizeof(K68TopRow) / sizeof(Key))

static const Key K65TopRow[] = { { 0, "Brightness", "light", 164 - K70_X_START, 0, 12, 12, true, true }, { 0, "Mute", "mute", 176 - K70_X_START, 0, 12, 12, true, true }, { 0, "Volume Down", "voldn", 192 - K70_X_START, 0, 14, 8, true, true }, { 0, "Volume Up", "volup", 205 - K70_X_START, 0, 14, 8, true, true }, { 0, "Windows Lock", "lock", 222 - K70_X_START, 0, 12, 12, true, true } };
#define K65_TOP_COUNT (sizeof(K65TopRow) / sizeof(Key))

static const Key K63TopRow[] = {
    { 0, "Stop", "stop", K70_X_START - 37, 0, 12, 8, true, true },          { 0, "Previous", "prev", K70_X_START - 26, 0, 12, 8, true, true },
    { 0, "Play/Pause", "play", K70_X_START - 15, 0, 12, 8, true, true },    { 0, "Next", "next", K70_X_START - 4, 0, 12, 8, true, true },
    { 0, "Brightness", "light", 170 - K70_X_START, 0, 12, 12, true, true }, { 0, "Windows Lock", "lock", 180 - K70_X_START, 0, 12, 12, true, true },
    { 0, "Mute", "mute", 222 - K70_X_START, 0, 13, 8, true, true },         { 0, "Volume Down", "voldn", 234 - K70_X_START, 0, 13, 8, true, true },
    { 0, "Volume Up", "volup", 246 - K70_X_START, 0, 13, 8, true, true }
};
...
static const Key KStrafeKeys[] = { { 0, "Sidelight", "lsidel", 0, KSTRAFE_HEIGHT / 2, KSTRAFE_X_START, KSTRAFE_HEIGHT, true, false }, { 0, "Sidelight", "rsidel", KSTRAFE_WIDTH, KSTRAFE_HEIGHT / 2, KSTRAFE_X_START, KSTRAFE_HEIGHT, true, false }, { 0, "Logo", "logo", KSTRAFE_X_START, 0, NS, true, false }, { 0, "Function", "fn", 152, 75, NS, true, true } };
...
static const Key K95PLbar[] = {
    { 0, 0, "topbar1", 4, -3, LBS, true, false },    { 0, 0, "topbar2", 19, -3, LBS, true, false },   { 0, 0, "topbar3", 34, -3, LBS, true, false },
    { 0, 0, "topbar4", 49, -3, LBS, true, false },   { 0, 0, "topbar5", 64, -3, LBS, true, false },   { 0, 0, "topbar6", 79, -3, LBS, true, false },
    { 0, 0, "topbar7", 94, -3, LBS, true, false },   { 0, 0, "topbar8", 109, -3, LBS, true, false },  { 0, 0, "topbar9", 124, -3, LBS, true, false },
    { 0, 0, "topbar10", 139, -3, LBS, true, false }, { 0, 0, "topbar11", 154, -3, LBS, true, false }, { 0, 0, "topbar12", 169, -3, LBS, true, false },
    { 0, 0, "topbar13", 184, -3, LBS, true, false }, { 0, 0, "topbar14", 199, -3, LBS, true, false }, { 0, 0, "topbar15", 214, -3, LBS, true, false },
    { 0, 0, "topbar16", 229, -3, LBS, true, false }, { 0, 0, "topbar17", 244, -3, LBS, true, false }, { 0, 0, "topbar18", 259, -3, LBS, true, false },
...
static const Key PolarisZones[]
    = { { 0, "Zone 1", "zone1", 65, 4, POLARIS_V, true, false },     { 0, "Zone 2", "zone2", 65, 16, POLARIS_V, true, false },
        { 0, "Zone 3", "zone3", 65, 28, POLARIS_V, true, false },    { 0, "Zone 4", "zone4", 65, 40, POLARIS_V, true, false },
        { 0, "Zone 5", "zone5", 65, 52, POLARIS_V, true, false },    { 0, "Zone 6", "zone6", 43, 62, POLARIS_H, true, false },
        { 0, "Zone 7", "zone7", 31, 62, POLARIS_H, true, false },    { 0, "Zone 8", "zone8", 19, 62, POLARIS_H, true, false },
        { 0, "Zone 9", "zone9", 7, 62, POLARIS_H, true, false },     { 0, "Zone 10", "zone10", -5, 62, POLARIS_H, true, false },
        { 0, "Zone 11", "zone11", -19, 52, POLARIS_V, true, false }, { 0, "Zone 12", "zone12", -19, 40, POLARIS_V, true, false },
        { 0, "Zone 13", "zone13", -19, 28, POLARIS_V, true, false }, { 0, "Zone 14", "zone14", -19, 16, POLARIS_V, true, false },
        { 0, "Zone 15", "zone15", -19, 4, POLARIS_V, true, false } };
...
static const Key ST100Zones[] = {
    { 0, "Zone 1", "zone1", 16, 10, ST100_H, true, false }, { 0, "Zone 2", "zone2", 36, 10, ST100_H, true, false },
    { 0, "Zone 3", "zone3", 52, 30, ST100_V, true, false }, { 0, "Zone 4", "zone4", 52, 50, ST100_V, true, false },
    { 0, "Logo", "zone5", 21, -1, NS, true, false }, // Logo
    { 0, "Zone 6", "zone6", 16, 66, ST100_H, true, false }, { 0, "Zone 7", "zone7", -4, 50, ST100_V, true, false },
    { 0, "Zone 8", "zone8", -4, 30, ST100_V, true, false }, { 0, "Zone 9", "zone9", -4, 10, ST100_H, true, false },
};
...
QList<QPair<int, QString>> KeyMap::layoutNames(QString layout)
{
    ...
    if (layout == "ansi")
        retlist << KeyMap::addToList(5, &list) << KeyMap::addToList(6, &list);
    else if (layout == "iso")
        retlist << KeyMap::addToList(0, &list) << KeyMap::addToList(1, &list) << KeyMap::addToList(2, &list) << KeyMap::addToList(3, &list) << KeyMap::addToList(4, &list) << KeyMap::addToList(7, &list) << KeyMap::addToList(8, &list) << KeyMap::addToList(9, &list) << KeyMap::addToList(11, &list) << KeyMap::addToList(12, &list) << KeyMap::addToList(14, &list) << KeyMap::addToList(15, &list) << KeyMap::addToList(16, &list);
    else if (layout == "abnt")
...
KeyMap::KeyMap(Model _keyModel, Layout _keyLayout)
    : _keys(getMap(_keyModel, _keyLayout)), keyWidth(modelWidth(_keyModel)), keyHeight(modelHeight(_keyModel)), keyModel(_keyModel), keyLayout(_keyLayout)
{}

KeyMap::KeyMap() : keyWidth(0), keyHeight(0), keyModel(NO_MODEL), keyLayout(NO_LAYOUT) {}
...
QString KeyMap::friendlyName(const QString& key, Layout layout)
{
    ...
    if (key == "f13" || key == "f14" || key == "f15" || key == "f16" || key == "f17" || key == "f18" || key == "f19" || key == "f20" || key == "f21" || key == "f22" || key == "f23" || key == "f24")
        return key.toUpper();
    else if (key == "lightup")
