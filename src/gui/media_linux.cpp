...
static void ContextStateCallback(pa_context* context, void* data)
{
    ...
    if (state == PA_CONTEXT_READY)
    {
        ...
        if (!CheckPAOperation(pa_context_subscribe(context, static_cast<pa_subscription_mask_t>(PA_SUBSCRIPTION_MASK_SINK | PA_SUBSCRIPTION_MASK_SERVER), nullptr, nullptr)))
